  ...
  return (
    <header className="notifications-header">
      <div className="notifications-header-container">
        ...
        <div className="notifications-header-right" style={{ display: 'flex', gap: '12px' }}>
          {unreadCount > 0 && (
            <button
          ...
          <Link href="/settings/notifications" className="notifications-header-btn-icon" aria-label="Notification Settings">
            <svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2.5" strokeLinecap="round" strokeLinejoin="round">
